...
export default function OrderDetailError({
  ...
  return (
    <div className="space-y-6 rounded-2xl border border-amber-200 bg-amber-50/50 p-8">
      <h2 className="text-xl font-semibold text-amber-900">שגיאה בטעינת פרטי ההזמנה</h2>
      <p className="text-sm text-amber-800 font-mono break-all">{error?.message ?? String(error)}</p>
