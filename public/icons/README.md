...
Custom illustrated icons for meat products. Style: raw product on parchment, circular border, white background, mix-blend-multiply.

## Required assets (80×80 px PNG)

| File | Product types | Status |
|------|---------------|--------|
| entrecote.png | אנטריקוט | ✅ |
| ground-meat.png | טחון בקר, טחון בקר+כבש | ✅ |
| schnitzel.png | שניצל עגל, שניצל עוף דק | ✅ |
